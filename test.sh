...
check_contains "homepage" "/" "PageDiff API"
check_contains "openapi" "/openapi.json" "/diff"
check_contains "x402 metadata" "/.well-known/x402.json" "50000"
check_contains "agent-card" "/.well-known/agent-card.json" "diff_web_page_snapshots"
...
check_not_contains "x402 metadata" "/.well-known/x402.json" "/score/lead"
echo ""

echo "4. Page diff without payment"
check_payment_challenge "page diff" "/diff" '{"url":"https://example.com/","from":"2023-01-01","to":"2024-01-01"}' "50000"
echo ""
